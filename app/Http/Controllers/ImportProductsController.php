...
class ImportProductsController extends Controller
{
    ...
    {
        //Cast to float to prevent "Unsupported operand types: string * int" error
        //when values from spreadsheet import are strings (e.g. product names with special characters)
        $dpp_exc_tax = (float) $dpp_exc_tax;
        $dpp_inc_tax = (float) $dpp_inc_tax;
