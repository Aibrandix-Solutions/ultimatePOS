            ...
            <div class="col-12 col-lg-10 col-xl-8">
                <div class="card register-card border-0">
                    ...
                    <div class="register-header">
                        <h1 class="register-title h2">{{ config('app.name', 'Ultimate POS') }}</h1>
                        <p class="register-subtitle">Register and Get Started in minutes</p>
                    </div>
                    ...
                    <div class="p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            <h3 class="h5 fw-bold text-primary border-bottom pb-2 mb-4">Personal Information</h3>
