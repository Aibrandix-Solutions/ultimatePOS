...
return [
    ...
    'installment_plan_return_warning' => 'This sale has an installment plan. Return amount: :amount. Please update the pending installment amounts for invoice :invoice.',
    'installment_plan_adjust_alert' => 'The pending installment total does not match the balance after returns. Update the amounts below.',
    'installment_plan_adjust_after_return' => 'A product was returned on this invoice. Review and update the pending installment amounts.',
    'total_returns' => 'Total returns',
    'balance_after_returns' => 'Balance after returns',
    'remaining_installment_balance' => 'Remaining installment balance',
    'pending_installments_total' => 'Pending installments total',
    'suggested_amount' => 'Suggested',
    'apply_suggested_amounts' => 'Apply suggested amounts',
    'update_installment_amounts' => 'Update installment amounts',
    'installment_plan_updated_success' => 'Installment amounts updated successfully',
    'installment_plan_not_active' => 'This installment plan is not active and cannot be edited.',
    'installment_no_pending_lines' => 'There are no pending installments to update.',
    'installment_line_amount_required' => 'Amount is required for installment :sequence.',
    'installment_line_amount_invalid' => 'Invalid amount for installment :sequence.',
    'installment_line_amount_below_paid' => 'Installment :sequence cannot be less than the amount already paid on that line.',
    'installment_pending_total_mismatch' => 'Pending installments must total :expected. You entered :entered.',
    'update_installment_plan' => 'Update installment plan',
    'installment_customer_credit' => 'Customer has overpaid by :amount after returns. Refund cash or keep as customer credit.',
    'installment_remaining' => 'Remaining',
    'installment_status_partial' => 'Partial',
    'installment_next_payment_hint' => 'Next installment due: :amount for installment #:sequence',
